...
import { getJobSeekerDetails, updateJobSeekerDetails } from '../../services/jobSeeker';
    ...
    if ((data && !data?.resume) || (resCheck) || !viewData) {
        resumeHandlerFlex = (<div className="resume-upload">
            ...
            <div >
                ...
                <input style={{ width: "100%" }} type="file" onChange={uploadResume} />
            </div>
            <Button
                text="Save"
                onClick={saveURL}
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", width: "40%" }} >
                        ...
                        <div >
                            <svg width="44" height="64" viewBox="0 0 44 64">
                                ...
                                <path d="M0 2C0 0.895431 0.895431 0 2 0H27C28.1046 0 29 0.895431 29 2V13C29 14.1046 29.8954 15 31 15H42C43.1046 15 44 15.8954 44 17V62C44 63.1046 43.1046 64 42 64H2C0.895431 64 0 63.1046 0 62V2Z" fill="#E4E2E0">
                                </path>
                                <path d="M0 44H44V62C44 63.1046 43.1046 64 42 64H2C0.895431 64 0 63.1046 0 62V44Z" fill="#085ff7">
                                </path>
                                <text fill="#FFFFFF" font-weight="700" font-size="12"> <tspan x="10" y="58">PDF</tspan></text>
                            </svg>
                        </div>
                        <div>
    ...
    return (
        <div className="container">
            ...
            <div className="profile-wrapper">
                ...
                {
                    showEditDiv === false ? (<div class="profile-flex-box">
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <div>{viewData?.firstName} {viewData?.lastName} </div>
                        <div>{viewData?.email}</div>
                        <div>{viewData?.phoneNumber}</div>
                    </div>) : (<div class="profile-flex-box">
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <h5><b>Contact Information:</b></h5>
                        </div>
                        <Input
                        ...
                        <h5><b>Location</b></h5>
                        <p>Providing a specific location helps Indeed connect you with the right job.
