...
const JobApplicantCard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "http://localhost:3900/employer/api/getCompanyJobs/619d46a4c6f3fa96b4f6cb5e",
        {}
      )
      .then((response) => {
            ...
            return (
              <div className="review-card-wrapper">
                ...
                <div className="job-card-role-summary">
                  <ul>
                    <li>
                      Refine ideas and come up with new ones to design a highly
                      polished visual experience.
                    </li>
                    <li>
                      Collaborate with other designers to help build a strong
                      design team and culture.
                    </li>
                  </ul>
                  {/*  */}
                </div>
                <div className="job-card-posted-ago">7 days ago</div>
              </div>
            );
          });
          setJobs(postData);
