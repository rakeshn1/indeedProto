                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="form-group">
                                                ...
                                                <p className="help-block text-danger">{errors.name && touched.name ? (
                                                        <>{errors.name}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.about && touched.about ? (
                                                        <>{errors.about}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.ceo && touched.ceo ? (
                                                        <>{errors.ceo}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group">
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.happinessScore && touched.happinessScore ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.learningScore && touched.learningScore ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.appreciationScore && touched.appreciationScore ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.companySize && touched.companySize ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.revenue && touched.revenue ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.industry && touched.industry ? (
                                                        <>{errors.industry}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.description && touched.description ? (
                                                        <>{errors.description}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group">
                                                ...
                                                <p className="help-block text-danger">{errors.mission && touched.mission ? (
                                                        <>{errors.mission}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.values && touched.values ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.workCulture && touched.workCulture ? (
                                                        <>{errors.workCulture}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group">
                                                ...
                                                <p className="help-block text-danger">{errors.vision && touched.vision ? (
                                                        <>{errors.vision}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.companyType && touched.companyType ? (
                                                        <>{errors.companyType}</>
                                                    ) : null}</p>
                                            </div>
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">
                                                    {errors.headQuarters && errors.headQuarters.streetName && touched.headQuarters && touched.headQuarters.streetName ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">
                                                    {errors.headQuarters && errors.headQuarters.city && touched.headQuarters && touched.headQuarters.city ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">
                                                    {errors.headQuarters && errors.headQuarters.state && touched.headQuarters && touched.headQuarters.state ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">
                                                    {errors.headQuarters && errors.headQuarters.country && touched.headQuarters && touched.headQuarters.country ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">
                                                    {errors.headQuarters && errors.headQuarters.zipcode && touched.headQuarters && touched.headQuarters.zipcode ? (
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <p className="help-block text-danger">{errors.websiteURL && touched.websiteURL ? (
                                                        <>{errors.websiteURL}</>
                                                    ) : null}</p>
                                            </div>
                                            <div className="form-group" >
